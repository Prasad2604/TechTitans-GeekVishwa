...
st.subheader("Smart Solutions for Bright Minds: Your School Assistant Chatbot - Learning, Chatting, Excelling Together!")
st.title("ChatMinds: Your Ultimate School Assistant Chatbot")
